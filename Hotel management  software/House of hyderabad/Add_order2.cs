...
{
    public partial class Add_order2 : Form
    {
        public Add_order2()
        {
            InitializeComponent();
        ...
        private void Add_order2_Load(object sender, EventArgs e)  // on Load
        {
            displayRecord();
            displayRecord1();
            displayRecord2();
        ...
        private void button6_Click(object sender, EventArgs e) // sales Menu
        {
            Sales_menu mm = new Sales_menu();
            this.Hide();
            mm.Show();
        }
